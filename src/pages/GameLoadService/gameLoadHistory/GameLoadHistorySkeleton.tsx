// src/pages/GameLoadService/gameLoadHistory/GameLoadHistorySkeleton.tsx
import { Skeleton } from "@/components/ui/skeleton";

export const GameLoadHistorySkeleton = () => {
  return (
        ...
        <div key={i} className="bg-[#1a1c23] rounded-lg p-6 shadow-sm border border-[#2a2d36]">
          <div className="flex flex-col sm:flex-row justify-between gap-4 mb-4">
            <div className="space-y-2 flex-1">
                <div className="flex items-center gap-2">
                    <Skeleton className="h-5 w-16 bg-[#2a2d36]" />
          ...
          <div className="flex items-center justify-between mt-4">
            <div className="flex items-center gap-3">
              ...
              <Skeleton className="h-5 w-36 bg-[#2a2d36]" />
            </div>
