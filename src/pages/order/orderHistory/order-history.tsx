...
import { fetchUserOrdersRpc, Order as FetchedSupabaseOrder } from "@/pages/order/orderHistory/orderService"; // Use alias
import { Pagination } from "@/pages/searchPage/search/Pagination"; // Ensure path is correct
