...
const OrderHistory = () => {
  ...
  // Sort filtered orders by order date (newest first)
  const sortedOrders = filteredOrders
    ? [...filteredOrders].sort(
        (a, b) =>
          new Date(b.orderdetails.order_date).getTime() -
          new Date(a.orderdetails.order_date).getTime()
      )
    : [];
  ...
  }, [sortedOrders, currentPage, totalPages]);
  ...
  useEffect(() => {
    document.title = "[GNT] Order History";
  }, []);
